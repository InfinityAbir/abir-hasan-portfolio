    ...
    <section id="hero" className="relative min-h-[100vh] flex flex-col pt-12 md:pt-16 overflow-hidden bg-background">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full flex-1 flex flex-col md:flex-row items-center justify-center gap-12 md:gap-20 pb-12">
        ...
        >
          ...
          >
            <a key="github" href="https://github.com/InfinityAbir" target="_blank" rel="noreferrer" aria-label="GitHub" className="text-muted-foreground hover:text-foreground transition-colors hover:-translate-y-1 transform duration-200">
              <Github className="w-5 h-5" />
            </a>
            <a key="linkedin" href="https://linkedin.com/in/infinityabirhasan" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="text-muted-foreground hover:text-foreground transition-colors hover:-translate-y-1 transform duration-200">
              <Linkedin className="w-5 h-5" />
            </a>
            <a key="mail" href="mailto:abirha3896@gmail.com" aria-label="Email" className="text-muted-foreground hover:text-foreground transition-colors hover:-translate-y-1 transform duration-200">
        ...
        >
          ...
          >
            <div className="flex flex-col h-full bg-card w-full">
              ...
              <div className="relative px-5 pt-7 pb-6 flex flex-col items-center bg-gradient-to-br from-cyan-700 via-primary to-indigo-950 text-white overflow-hidden">
              ...
              <div className="p-5 flex flex-col items-center text-center bg-card text-card-foreground flex-1 gap-3">
                <div>
                  <h3 className="text-xl font-extrabold tracking-tight text-foreground">Abir Hasan</h3>
                ...
                <div className="grid grid-cols-2 gap-2.5 w-full text-left bg-muted/40 p-3 rounded-xl border border-border/50">
                  <div>
                    ...
                    <span className="font-bold text-foreground text-xs">Full-Stack & Blockchain</span>
                  </div>
                  <div>
                    <span className="text-muted-foreground block text-[9px] uppercase tracking-widest font-bold">Location</span>
                    <span className="font-bold text-foreground text-xs">Uttara, Dhaka</span>
                  </div>
                  <div>
