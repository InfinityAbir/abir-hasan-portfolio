...
export const EducationSection = () => {
  const education = [
    {
      degree: "Bachelor of Computer Science & Engineering (BCSE)",
      school: "IUBAT — International University of Business Agriculture and Technology",
      year: "2022 – 2026 · Dhaka",
      badge: "CGPA 3.72 / 4.00",
      badgeIcon: Sparkles,
      badgeColor: "text-emerald-400 bg-emerald-500/10 border-emerald-500/30",
      icon: GraduationCap,
      details: [
        "Core focus on Software Engineering, Algorithms, Data Structures, and System Design",
        "Undergraduate thesis: Blockchain Pension Management System built with Solidity smart contracts",
        "Active in the CSE department — mentored junior students in programming fundamentals",
      ]
    },
    {
      degree: "Higher Secondary School Certificate (HSC)",
      school: "Gaibandha Adarsha College, Gaibandha",
      year: "2020 – 2021",
      badge: "GPA 5.00 / 5.00",
      badgeIcon: Award,
      ...
      icon: BookOpen,
      details: [
        "Science group — Physics, Chemistry, and Higher Mathematics",
        "Graduated with a perfect 5.00 GPA",
      ]
    },
    {
      degree: "Secondary School Certificate (SSC)",
      school: "Govt. Boy's High School, Gaibandha",
      year: "2018 – 2019",
      badge: "GPA 5.00 / 5.00",
      badgeIcon: Award,
      badgeColor: "text-amber-400 bg-amber-500/10 border-amber-500/30",
    ...
    <section id="education" className="max-w-7xl mx-auto px-6 py-24">
      ...
      >
        ...
        <p className="text-muted-foreground text-lg max-w-2xl">
          A Computer Science & Engineering education grounded in theory, sharpened by shipping real products.
        </p>
      </motion.div>
