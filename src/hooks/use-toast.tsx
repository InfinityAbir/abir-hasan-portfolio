...
const toastWithMethods = Object.assign(toast, {
  default: (props: Omit<ToastOptions, "type">): ReturnType<typeof toast> =>
    toast({ ...props, type: "default" }),
  destructive: (props: Omit<ToastOptions, "type">): ReturnType<typeof toast> =>
    toast({ ...props, type: "destructive" }),
  success: (props: Omit<ToastOptions, "type">): ReturnType<typeof toast> =>
    toast({ ...props, type: "success", variant: "success" }),
  warning: (props: Omit<ToastOptions, "type">): ReturnType<typeof toast> =>
    toast({ ...props, type: "warning" }),
  info: (props: Omit<ToastOptions, "type">): ReturnType<typeof toast> =>
